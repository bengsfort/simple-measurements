...
const colours: ColourDict = {
	GREEN: StyleSheet.create({
		...
		number_key: { backgroundColor: ColourStyles.green['900'] },
		number_key_label: { color: ColourStyles.green['100'] },
		action_key: { backgroundColor: ColourStyles.green['800'] },
	}),
	PURPLE: StyleSheet.create({
		...
		number_key: { backgroundColor: ColourStyles.purple['800'] },
		number_key_label: { color: ColourStyles.purple['100'] },
		action_key: { backgroundColor: ColourStyles.purple['900'] },
	}),
};
